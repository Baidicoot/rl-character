...
def get_generation_prompt(characteristic: str, response: str, num_statements: int) -> str:
...
def get_seeded_generation_prompt(characteristic: str, response: str, num_statements: int, document: str) -> str:
...
def get_random_wikipedia_samples(num_samples: int = 1, max_length: int = 8192, seed: int = None) -> List[str]:
    """
