#!/usr/bin/env python3
"""Example usage of the code generation reward hacking framework."""

import asyncio
import os
import sys

# Add parent directory to path so we can import code_datasets
current_dir = os.path.dirname(os.path.abspath(__file__))
parent_dir = os.path.dirname(current_dir)
sys.path.insert(0, parent_dir)

from code_datasets.generation import (
    load_mbpp_problems,
    CodeProblem, TestCase, test_solution, execute_code,
    load_apps_problems
)
...
"""
    ...
    # 4. Load APPS problems
    print("\n4. Loading APPS problems...")
    apps_problems = await load_apps_problems(num_problems=3)
    print(f"   Loaded {len(apps_problems)} APPS problems")
