...
from .generation.experiment import run_experiment
...
Examples:
  ...
  python -m code_datasets.generation_cli generate --model claude-3-haiku-20240307 --dataset data/test_dataset.json
  
  # Generate training data with completions
  python -m code_datasets.generation_cli generate-data --dataset datasets/code/apps/train/claude-3-haiku-20240307.json --model gpt-4o-mini --problem-prompt neutral --fraction-broken-tests 0.5 --max-retries 3
  
  # View results
  python -m code_datasets.generation_cli view results/summary.json
        """
    )
