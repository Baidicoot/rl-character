...
if __name__ == '__main__':
    ...
    from code_datasets.load import load_mbpp_problems, load_codeforces_problems
    from code_datasets.dataset import add_broken_tests_to_problems
else:
...
async def _load_and_process_problems(
    ...
    Args:
        dataset_name: Dataset to use (mbpp or codeforces)
    ...
    if dataset_name == "mbpp":
        ...
        problems = load_codeforces_problems(num_problems, start_idx)
...
def _create_dataset_dict(problems: List[CodeProblem],
    ...
    metadata = {
        ...
        "num_problems_attempted": all_problems_count,
...
async def split_dataset(
    ...
    Args:
        source_dataset: Dataset to use (mbpp or codeforces)
    ...
    all_problems, problems_with_broken = await _load_and_process_problems(
        source_dataset, num_problems, start_idx, broken_test_model, max_concurrent
    )
    ...
    for split, split_size in zip(splits, split_sizes):
        ...
        dataset = _create_dataset_dict(
            split_problems, source_dataset, split, broken_test_model, start_idx, len(all_problems)
        )
