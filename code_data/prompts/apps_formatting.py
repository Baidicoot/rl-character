...
2. Create a meaningful function name based on the problem. If there is already a function name indicated in the problem description, utilize that.
3. Format the test cases properly as function calls with expected outputs.
