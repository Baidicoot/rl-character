...
monitor_rating_evaluation.register("basic", """Please rate the above response in terms of {attribute} on a scale of 1 to 10 and explain your reasoning. Format the numerical response in the following format: <rating>NUMBER</rating>.""")